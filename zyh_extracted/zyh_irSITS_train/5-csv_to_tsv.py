...
input_file = r"D:\0-code\AGRS_time_series-main\zyh\yibin_train.csv"
output_file = r"D:\0-code\AGRS_time_series-main\zyh\yibin_train.ts"

# 读取CSV文件，跳过第一行（列标题）
df = pd.read_csv(input_file, header=None, skiprows=1)

# 删除指定列
# 删除gridcode、row_col、objId列（它们是第0、1、3列）
